...
Defined in: [packages/db/src/query/live-query-collection.ts:62](https://github.com/roger120981/optimistic/blob/main/packages/db/src/query/live-query-collection.ts#L62)
