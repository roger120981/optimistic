...
Defined in: [packages/db/src/query/live/collection-config-builder.ts:39](https://github.com/roger120981/optimistic/blob/main/packages/db/src/query/live/collection-config-builder.ts#L39)
